using _2023_05_23_Kutyak_programozasi_feladat;
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            kutyak.Where(x => x.Utolso_ellenorzes == new DateTime(2018, 1, 10))
            ...
            //9.
            var legterheltebbNap = kutyak.GroupBy(x => x.Utolso_ellenorzes).MaxBy(x => x.Count());
